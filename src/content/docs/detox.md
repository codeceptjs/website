...
It is important to follow [Detox guide](https://wix.github.io/Detox/docs/introduction/getting-started) to build an application with Detox test instrouments included.
...
> For more details on actions refer to the [API reference of Detox helper](/helpers/detox).
...
For hybrid apps with WebView content, you can switch to web context in Appium and use web locators, including ARIA locators like `{ aria: 'Submit' }`.
...
You can also pass all [other arguments that Detox CLI supports](https://wix.github.io/Detox/docs/api/detox-cli/#test).
