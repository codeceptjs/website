...
Acceptance tests interact with websites using UI and a real browser.
...
Most web applications have APIs, and they can be used to create and delete test records.
...
*   `cleanup` (default: true): should inserted records be deleted after tests
...
Requests can also be overridden with a function which returns [axios request config][4].
...
[2]: https://www.npmjs.com/package/@faker-js/faker
