...
GraphQL helper allows sending additional requests to a GraphQL endpoint during acceptance tests.
...
*   onRequest: an async function which can update request object.
...
Returns **[object][2]** GraphQL request
...
Send mutation to GraphQL endpoint over HTTP
